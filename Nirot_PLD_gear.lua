...
function init_gear_sets()
    ...
    sets.precast.WS['Requiescat'].PDT = set_combine(sets.precast.WS['Requiescat'], {}) --{ring1="Leviathan Ring",ring2="Aquasoul Ring"})
    sets.precast.WS['Requiescat'].MDT = set_combine(sets.precast.WS['Requiescat'], {})
    sets.precast.WS['Requiescat'].Acc = set_combine(sets.precast.WS['Requiescat'], {waist=gear.ElementalBelt}) --{ring1="Leviathan Ring"})
    ...
    sets.precast.WS['Chant du Cygne'].PDT = set_combine(sets.precast.WS['Chant du Cygne'], {}) --{hands="Buremte Gloves",waist="Zoran's Belt"})
    sets.precast.WS['Chant du Cygne'].MDT = set_combine(sets.precast.WS['Chant du Cygne'], {}) --{hands="Buremte Gloves",waist="Zoran's Belt"})
    sets.precast.WS['Chant du Cygne'].Acc = set_combine(sets.precast.WS['Chant du Cygne'], {}) --{waist="Zoran's Belt"})
	...
	--{ammo={ name="Ginsen", priority=1},
        -- head={ name="Reverence Coronet +3", priority=71},neck="Eddy Necklace",ear1={name="Friomisi Earring", priority=1},ear2="Hecate's Earring",
        -- body="Reverence Surcoat +1",hands={ name="Reverence Gauntlets +3", priority=113},ring1="Shiva Ring",ring2="K'ayres Ring",
	...
	--sets.precast.FC.SIRD = sets.midcast.SIRD  -- use this if you have to
	
	sets.Phalanx = {--main="Sakpata's Sword",sub={ name="Priwen", augments={'HP+50','Mag. Evasion+50','Damage Taken -3%',}},
    ...
    sets.idle.Town = sets.idle --{main="Anahera Sword",ammo="Incantor Stone",
        -- head={ name="Reverence Coronet +3", priority=71},neck="Creed Collar",ear1="Creed Earring",ear2="Bloodgem Earring",
        -- body="Reverence Surcoat +1",hands={ name="Reverence Gauntlets +3", priority=113},ring1="Sheltered Ring",ring2="Meridian Ring",
        -- back="Fierabras's Mantle",waist="Flume Belt",legs="Crimson Cuisses",feet="Reverence Leggings +1"}
    
    sets.idle.Weak = sets.idle --{ammo="Iron Gobbet",
        -- head={ name="Reverence Coronet +3", priority=71},neck="Creed Collar",ear1="Creed Earring",ear2="Bloodgem Earring",
        -- body="Reverence Surcoat +1",hands={ name="Reverence Gauntlets +3", priority=113},ring1="Sheltered Ring",ring2="Meridian Ring",
        -- back="Fierabras's Mantle",waist="Flume Belt",legs="Crimson Cuisses",feet="Reverence Leggings +1"}
    ...
    sets.defense.HP = {} -- {ammo="Iron Gobbet",
        -- head={ name="Reverence Coronet +3", priority=71},neck="Loricate Torque +1",ear1="Creed Earring",ear2="Bloodgem Earring",
        -- body="Reverence Surcoat +1",hands={ name="Reverence Gauntlets +3", priority=113},ring1={ name="Defending Ring",priority=1},ring2="Meridian Ring",
        -- back="Weard Mantle",waist={ name="Creed Baudrier", priority=40},legs="Reverence Breeches +1",feet="Reverence Leggings +1"}
    sets.defense.Reraise = {} --{ammo="Iron Gobbet",
        -- head="Twilight Helm",neck="Loricate Torque +1",ear1="Creed Earring",ear2="Bloodgem Earring",
        -- body="Twilight Mail",hands={ name="Reverence Gauntlets +3", priority=113},ring1={ name="Defending Ring",priority=1},ring2=gear.DarkRing.physical,
    ...
    sets.defense.Charm = {} --{ammo="Iron Gobbet",
        -- head={ name="Reverence Coronet +3", priority=71},neck="Lavalier +1",ear1="Creed Earring",ear2="Buckler Earring",
        -- body="Reverence Surcoat +1",hands={ name="Reverence Gauntlets +3", priority=113},ring1={ name="Defending Ring",priority=1},ring2=gear.DarkRing.physical,
   ...
   -- sets.engaged.PDT = set_combine(sets.engaged, {body={ name="Caballarius Surcoat +3", priority=138},neck={name="Kgt. Beads +2", priority=60},ring1={ name="Defending Ring",priority=1},back={ name="Rudianos's Mantle", augments={'HP+60','Eva.+20 /Mag. Eva.+20','Mag. Evasion+10','Enmity+10','Damage taken-5%',}}})
    ...
    sets.buff.Doom = {neck={ name="Nicander's Necklace", priority=1},ring1={ name="Eshmun's Ring", priority=1},ring2={ name="Eshmun's Ring", priority=1},waist={ name="Gishdubar Sash", priority=1},legs={ name="Shabti Cuisses +1",priority=41}} --{ring2="Saida Ring"}
